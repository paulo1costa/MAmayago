...
function exp_centroides_maio_agosto_5rule0_eval_expression(context) {
    // month(Data) = 5

    var feature = context.feature;
    
    if (feature.properties) {
        return (fnc_month([feature.get('Data') ], context) == 5);
    } else {
        return (fnc_month([feature.get('Data') ], context) == 5);
    }
}
...
function exp_centroides_maio_agosto_5rule1_eval_expression(context) {
    // month(Data) = 6

    var feature = context.feature;
    
    if (feature.properties) {
        return (fnc_month([feature.get('Data') ], context) == 6);
    } else {
        return (fnc_month([feature.get('Data') ], context) == 6);
    }
}
...
function exp_centroides_maio_agosto_5rule2_eval_expression(context) {
    // month(Data) = 7

    var feature = context.feature;
    
    if (feature.properties) {
        return (fnc_month([feature.get('Data') ], context) == 7);
    } else {
        return (fnc_month([feature.get('Data') ], context) == 7);
    }
}